...
const (
	...
	// The embedded shell (stage 08).
	//
	// sandbox_exec fires for EVERY program the shell runs, including the ones
	// nobody typed — what a pipeline, a loop, a glob or an `eval` expanded to.
	// That is a lot of events for one command, and it is the whole value: it is
	// the difference between knowing what was asked for and knowing what ran.
