...
comparing. When `02-see-everything/code/exec.go` changes, either the level's
...
```jsonc
"source": {
  "file": "02-see-everything/code/exec.go",
  "extract": [
...
NN/code NN+1/code` shows one idea arriving.
...
"reveal": {
  ...
  "diff": { "from": "01-dont-die/code/exec.go", "to": "02-see-everything/code/exec.go" },
...
```json
{
  ...
  "reveal": {
    ...
    "diff": { "from": "01-dont-die/code/main.go", "to": "02-see-everything/code/exec.go" },
  ...
  "questions": [
    {
      ...
      "source": "02-see-everything/code/trace.go"
    },
    {
      "id": "q2",
      "kind": "predict",
