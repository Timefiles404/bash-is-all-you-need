...
func (c providerConfig) build(cacheBreakpoints bool) (Provider, error) {
	...
	case "anthropic":
		return newAnthropicProvider(base, key, c.Model).withCacheBreakpoints(cacheBreakpoints), nil
	default:
