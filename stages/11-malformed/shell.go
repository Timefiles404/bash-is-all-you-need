// Stage 11 — wiring the interactive shell.
//
...
// tool-call boundary wants a window that does not close when a value is
// missing, a key that stops a runaway turn, and a way to fix the endpoint
...
// return is a whole front end arriving nine stages later without needing one
