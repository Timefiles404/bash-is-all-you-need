// Stage 10 — wiring the interactive shell.
//
...
// deadlines wants a window that does not close when a value is missing, a key
// that stops a runaway turn, and a way to fix the endpoint without editing a
// file.
//
...
// return is a whole front end arriving eight stages later without needing one
...
//
// A table rather than one command each, because there are fifteen of them and
